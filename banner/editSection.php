...
?>
			...
			<script type="text/javascript" src="<?php echo SCRIPT ?>banner/editSection.js"></script>
			<div id="ja-container" class="wrap ja-r2">
				<div class="main clearfix">
					<div class="notification success" style="display:none;" >
							...
							<br/>
					<form id="editSection" action="<?php echo SITE ?>do.php" method="post">
						<table class="contenttoc" style="float:none">
							
							<tr>
								<td><label for="name"> Nombre (Sección /Zona) </label></td>
								<td><input type="text" name="name" id="name" class="inputbox" size="130" value="<?=$bannersection->prepareName()?>" /></td>
							</tr>
							
							<tr>
								<td colspan="2">
									<input type="hidden" name="id_bannersection" value="<?php echo $id_bannersection; ?>" />
									<input type="hidden" name="whatToDo" value="bannersection_edit" />
